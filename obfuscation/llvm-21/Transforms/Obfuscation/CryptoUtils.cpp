...
//===----------------------------------------------------------------------===//
//
// 本文件实现基于AES-CTR的密码学安全伪随机数生成器
//
// 创建日期: 2012年6月22日
// 最后修改: 2013年11月15日
// 作者: jrinaldini, pjunod
//
//===----------------------------------------------------------------------===//
...
/**
 * @brief 构造函数，初始化CryptoUtils对象
 */
CryptoUtils::CryptoUtils() { seeded = false; }

/**
 * @brief 使用AES对32位整数进行混淆
 * @param in 输入的32位整数
...
/**
 * @brief 使用指定种子初始化PRNG
 * @param _seed 种子字符串（32或34个字符的十六进制字符串）
 */
